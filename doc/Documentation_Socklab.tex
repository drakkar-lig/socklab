...
\author{$Revision: 386 $}
\date{$Date: 2011-04-21 09:31:07 +0200 (Thu, 21 Apr 2011) $}
...
L.CROQ & L.SALTI - ENSIMAG - Juillet 1993
--------------------------------------------------------------------------
socklab>
\end{verbatim}
...
ce n'est pas le cas), \texttt{Connexion} indique si une connexion est établie, et \texttt{RWX} indique 
...
LISTE DES COMMANDES DISPONIBLES:
    ...
    b bind              v recv              d send            = status
    l listen            f recvfrom          t sendto          q quit
    a accept            x exit            
    c connect           <id> select. sock.
    k close
    h shutdown
    o options
